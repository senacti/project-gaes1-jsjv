...
<body>
  ...
  <header class="menu">
    ...
    <ul class="barra">
      ...
      <h2><a href=" {{route('login')}}" class="Admin">Iniciar sesion</h2></a>
      </div>
 ...
 <h1 class="Titulo">Elije un Servicio</h1>
  ...
  <div class="Catalogo">
    ...
    <div class="servicio2">
      ...
      <a href="{{route('login')}}">Lavanderia</a>
    ...
    <div class="servicio3">
      ...
      <a href=" {{route('login')}}">Planchado</a>
    ...
    <div class="servicio4">
      ...
      <a href=" {{route('login')}}">Tintoreria</a>
